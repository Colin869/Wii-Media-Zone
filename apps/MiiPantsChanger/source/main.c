...
void Initialise() {
    ...
    if(isJapaneseWii) {
        printf("Mii パンツカラーチェンジャーが初期化されました！\n");
    } else {
        printf("Mii Pants Changer initialized successfully!\n");
    }
}
...
void DrawMenu() {
    if(isJapaneseWii) {
        DrawText(320, 30, "Mii パンツカラーチェンジャー", WHITE);
        ...
        DrawText(320, 30, "Mii Pants Color Changer", WHITE);
        DrawText(320, 60, "========================", WHITE);
